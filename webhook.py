...
# add elements to gui
msg_text_label = gui.Label(main_window, text="Message: ")
msg_text_entry = gui.Entry(main_window)
msg_text_button = gui.Button(main_window, text="Send message!", command=send_msg)
msg_text_checkbox_embed = gui.Checkbutton(main_window, text="Embed mode", variable=checkbox_embed_bool, command=update_gui)
msg_text_button_exit = gui.Button(main_window, text="Quit", command=quit_, bg = "red", fg = "white")
...
# embed text
embed_text_label_text = gui.Label(main_window, text="Embed title:")
embed_text_label = gui.Entry(main_window)

embed_footer_text = gui.Label(main_window, text="Embed footer:")
...
# we dont need these, because we used place before
#msg_text_label.pack()
#msg_text_entry.pack()
